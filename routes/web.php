...
Route::middleware(['auth'])->group(function () {
    ...
    Route::match(['get', 'post'], 'activity-report-modal-new', [ReportController::class, 'activityReportModalNew']);
    Route::get('assign-report-new', [ReportController::class, 'assignReportNew']);
