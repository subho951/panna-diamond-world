            ...
            <div class="card-body">
                <form id="formAccountSettings" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="emoji" class="form-label">Emoji <small class="text-danger">*</small></label>
                            <input class="form-control" type="text" id="emoji" name="emoji" value="<?=$emoji?>" required placeholder="Emoji" />
                        </div>
                        <div class="col-md-6">
