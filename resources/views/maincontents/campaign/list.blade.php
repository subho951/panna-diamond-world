            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'campaigns',
                  'columns' => ['campaign_type_id', 'name', 'year', 'start_date', 'end_date', 'created_at', 'campaigns.status'],
                  'visibleColumns' => ['campaign_type_name', 'name', 'year', 'start_date', 'end_date', 'created_at'],
                  'headers' => ['#', 'Campaign Type Name', 'Name', 'Year', 'Start Date', 'End Date', 'Created At'],
                  'filename' => "Campaign",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
