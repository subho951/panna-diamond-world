                            ...
                            <tr>
                                ...
                                <th class="text-center">Total Calls</th>
                                  ...
                                  @foreach($eachBranchWiseTelecallerActivity["totalParentStatusSlugArr"] as $eachtotalParentStatusSlugArr)
                                    @if(!empty($eachtotalParentStatusSlugArr["name"]))
                                      <th class="text-center">{{ $eachtotalParentStatusSlugArr["name"] }}</th>
                                    @endif
                                  @endforeach
                              ...
                              @foreach($eachBranchWiseTelecallerActivity["telecallerActivity"] as $key => $value)
                                ...
                                <tr>
                                    ...
                                    @foreach($value["parentStatusSlugArr"] as $eachparentStatusSlugArr)
                                      <td class="text-center">{{ $eachparentStatusSlugArr["slug_count"] }}</td>
                                    @endforeach
                      ...
                      @if(!empty($eachBranchWiseTelecallerActivity["telecallerActivity"]))
                          ...
                          @endforeach
                            <tr>
                              ...
                              @foreach($eachBranchWiseTelecallerActivity["totalParentStatusSlugArr"] as $eachtotalParentStatusSlugArr)
                                <td class="text-center text-primary fw-bold">{{ $eachtotalParentStatusSlugArr["SUM_slug_count"] }}</td>
                              @endforeach
...
$(document).ready(function(){
  ...
  $(document).on('click', '.exportAsCSV', function() {
      ...
      link.download = branchName + "_assign_report_" + formattedDateTime + ".csv";
      link.click();
