          ...
          <ul class="p-0 m-0">
            <li class="mb-4 d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <img
                  src="<?=config('constants.admin_assets_url')?>assets/img/icons/brands/laravel-logo.png"
                  alt="laravel-logo"
                  class="me-4"
                  width="35" />
                <div>
            ...
            <li class="mb-4 d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <img
                  src="<?=config('constants.admin_assets_url')?>assets/img/icons/brands/figma-logo.png"
                  alt="figma-logo"
                  class="me-4"
                  width="35" />
                <div>
            ...
            <li class="mb-4 d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <img
                  src="<?=config('constants.admin_assets_url')?>assets/img/icons/brands/vue-logo.png"
                  alt="vue-logo"
                  class="me-4"
                  width="35" />
                <div>
            ...
            <li class="mb-4 d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <img
                  src="<?=config('constants.admin_assets_url')?>assets/img/icons/brands/react-logo.png"
                  alt="react-logo"
                  class="me-4"
                  width="35" />
                <div>
            ...
            <li class="mb-4 d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <img
                  src="<?=config('constants.admin_assets_url')?>assets/img/icons/brands/bootstrap-logo.png"
                  alt="bootstrap-logo"
                  class="me-4"
                  width="35" />
                <div>
            ...
            <li class="d-flex">
              <div class="d-flex w-50 align-items-center me-4">
                <img
                  src="<?=config('constants.admin_assets_url')?>assets/img/icons/brands/sketch-logo.png"
                  alt="sketch-logo"
                  class="me-4"
                  width="35" />
                <div>
              ...
              <tr>
                <td class="pt-5">
                  <div class="d-flex justify-content-start align-items-center">
                    <div class="me-4">
                      <img src="<?=config('constants.admin_assets_url')?>assets/img/icons/payments/visa-img.png" alt="Visa" height="30" />
                    </div>
              ...
              <tr>
                <td>
                  <div class="d-flex justify-content-start align-items-center">
                    <div class="me-4">
                      <img
                        src="<?=config('constants.admin_assets_url')?>assets/img/icons/payments/master-card-img.png"
                        alt="Visa"
                        height="30" />
                    </div>
                    <div class="d-flex flex-column">
              ...
              <tr>
                <td>
                  <div class="d-flex justify-content-start align-items-center">
                    <div class="me-4">
                      <img
                        src="<?=config('constants.admin_assets_url')?>assets/img/icons/payments/american-express-img.png"
                        alt="Visa"
                        height="30" />
                    </div>
                    <div class="d-flex flex-column">
              ...
              <div class="timeline-event">
                ...
                <div class="d-flex align-items-center mb-1">
                  <div class="badge bg-lighter rounded-3">
                    <img src="<?=config('constants.admin_assets_url')?>assets//img/icons/misc/pdf.png" alt="img" width="15" class="me-2" />
                ...
                <div class="d-flex justify-content-between flex-wrap gap-2">
                  <div class="d-flex flex-wrap align-items-center">
                    <div class="avatar avatar-sm me-2">
                      <img src="<?=config('constants.admin_assets_url')?>assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div>
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                      <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                        <li
                          ...
                          <img class="rounded-circle" src="<?=config('constants.admin_assets_url')?>assets/img/avatars/5.png" alt="Avatar" />
                        </li>
                        <li
                          data-bs-toggle="tooltip"
                          data-popup="tooltip-custom"
                          ...
                          title="Allen Rieske"
                          class="avatar pull-up">
                          <img class="rounded-circle" src="<?=config('constants.admin_assets_url')?>assets/img/avatars/12.png" alt="Avatar" />
                        </li>
                        <li
                          data-bs-toggle="tooltip"
                          data-popup="tooltip-custom"
                          ...
                          class="avatar pull-up">
                          <img class="rounded-circle" src="<?=config('constants.admin_assets_url')?>assets/img/avatars/6.png" alt="Avatar" />
                        </li>
                        <li class="avatar">
                          <span
