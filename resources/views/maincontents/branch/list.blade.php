            ...
            <div class="card-body">
               <div id="table-overlay-loader" class="text-loader">
                ...
                @include('components.table', [
                  ...
                  'searchId' => 'search1',
                  'table' => 'branches',
                  'columns' => ['prefix','name', 'email', 'phone_code', 'phone',  'address', 'pincode', 'status'],
                  'visibleColumns' => ['prefix', 'name', 'email', 'phone_code', 'phone' , 'address', 'pincode'],
                  'headers' => ['#', 'Prefix', 'Name', 'Email', 'Country Code', 'Phone' , 'Address', 'Pincode'],
                  'filename' => "Branch",
                  'orderBy' => 'id',
                  'orderType' => 'desc',
                  'conditions' => [
