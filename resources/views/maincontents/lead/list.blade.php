                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr>
                                            ...
                                            <td>
                                              <button class="btn btn-sm bg-label-primary mb-1" data-bs-toggle="modal" data-bs-target="#callModal" title="Call">
                                              ...
                                              <a href="" class="btn btn-sm btn-danger mb-1" onclick="return confirm('Are you sure?')" title="Delete">
                                                <i class="fa-solid fa-trash"></i>
                                            </a>
                                            <a href="" class="btn btn-sm bg-label-primary mb-1" title="Transfer Lead To Another User">
