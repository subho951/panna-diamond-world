...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
  ...
  <a href="<?=url('/dashboard')?>" class="app-brand-link d-none d-xl-block">
    ...
    <img src="<?=((Helper::getSettingValue('site_logo') != '')?config('constants.app_url') . config('constants.uploads_url_path') . Helper::getSettingValue('site_logo'):config('constants.no_image'))?>" alt="<?=Helper::getSettingValue('site_name')?>" class="d-block" style="height: 50px;width: 150px;" />
...
<a href="javascript:void(0);" class="layout-menu-toggle menu-link text-large d-block d-xl-none">
    ...
    <!-- <i class="ti ti-close d-block d-xl-none ti-md align-middle"></i> -->
  </a>
