...
<link rel="icon" type="image/x-icon"
    href="<?= Helper::getSettingValue('site_favicon') != '' ? config('constants.app_url') . config('constants.uploads_url_path') . Helper::getSettingValue('site_favicon') : config('constants.no_image') ?>" />
...
<!-- posting job wizard -->
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
...
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/bootstrap-select/bootstrap-select.css" />
<link rel="stylesheet" href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/select2/select2.css" />
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/@form-validation/form-validation.css" />

<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/typeahead-js/typeahead.css" />
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/apex-charts/apex-charts.css" />
<link rel="stylesheet" href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/swiper/swiper.css" />
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css" />
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css" />
<link rel="stylesheet"
    href="{{ config('constants.admin_assets_url') }}assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css" />
